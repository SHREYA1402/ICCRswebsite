...
///////////
 ...
 <li key={item.id} className={item.cName}>
         ...
         <div className="box-container">
            ...
            <div className="box">
               <button className="iccr-head" onClick={() => navigate('Login_RO')}>
                   <img id="img7" src={office} alt="Logo" />
                   <h3>Regional Office</h3>
               </button>
            </div>
            <div className="box">
               <button className="iccr-head" onClick={() => navigate('Login_Institute')}>
                   <img id="img8" src={institute} alt="Logo" />
                   <h3>Institute</h3>
               </button>
            </div>
            <div className="box">
               <button className="iccr-head" onClick={() => navigate('Student')}>
