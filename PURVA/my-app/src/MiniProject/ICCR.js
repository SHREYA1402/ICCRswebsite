...
export default function ICCR() {
   ...
   return (
      <>
        <Outlet />
         ...
         <div class="info">
            ...
            <div className="news_ICCR">
               <h1>Latest News</h1>
               <div className="newsItems_ICCR border"  >
                  <div>
         ...
         <div className='table_ICCR'>
            <table>
               ...
               <tbody>
                  <tr className='t1_ICCR'>
                     <td>1</td>
                     <td>Delhi University</td>
                     <td style={{ fontWeight: 'bold' }}>Approved</td>
                     <td><button className="button1_ICCR">View</button></td>
                  </tr>

                  <tr className='t2_ICCR'>
                     <td>2</td>
                     <td>Ahmedabad</td>
                     <td style={{ fontWeight: 'bold' }}>Approved</td>
                     <td><button className="button1_ICCR">View</button></td>
    ...
    <button className="button1_ICCR">REPORTS</button> */}
